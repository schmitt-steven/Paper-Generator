...
def run_literature_phase():
    ...
    # 2. Run literature search if not already generated
    if not PAPERS_JSON_FILE.exists():
        from phases.context_analysis.research_context_generator import ResearchContextGenerator
...
def test_fr2_papers_json_exists_and_valid():
...
def test_fr2_at_least_one_pdf_downloaded():
    """
    ...
    # Recursively search for any .pdf file in the literature directory
