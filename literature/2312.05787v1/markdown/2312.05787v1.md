...
processes _⟨S, A, G, γ, p_ _s_ 0 _, p_ _g_ _, T, R⟩_ (Liu et al., 2022). Here, _S_, _A_, _G_, and _γ_ are the state space, the action
space, the goal space, and the discount factor, respectively. _p_ _s_ 0 : _S →_ [0 _,_ 1] is the initial state distribution.
_p_ _g_ : _G →_ [0 _,_ 1] is the goal distribution. _T_ : _S × A × S →_ [0 _,_ 1] is the dynamics transition function.
_R_ : _S × A × G →_ R is the reward function, which is sparsely structured in our setting. At the beginning
of an episode, an agent receives the desired goal _g ∼_ _p_ _g_ ( _·_ ). At each discrete time step _t_, an environment
provides the agent with a state _s_ _t_ _∈S_, the agent responds by selecting an action _a_ _t_ _∈A_, and then the
environment provides the next reward _r_ _t_ _←R_ ( _s_ _t_ _, a_ _t_ _, g_ ) and state _s_ _t_ +1 _∈S_ . For convenience, as needed,
we use the simpler notations of _r_, _s_, _a_, _s_ _[′]_, and _a_ _[′]_ to refer to a reward, state, action, next state, and next
action, respectively. In addition, as needed, we use the notation of _g_ _t_ _[′]_ _[∈G]_ [ and] _[ r]_ _t_ _[′]_ _[←R]_ [(] _[s]_ _[t]_ _[, a]_ _[t]_ _[, g]_ _t_ _[′]_ [) to refer]
...
_,_ _a_ _t_ _∼_ _π_ ( _·|s_ _t_ _, g_ ) _,_ _g ∼_ _p_ _g_ ( _·_ ) _, s_ _t_ +1 _∼T_ ( _·|s_ _t_ _, a_ _t_ ) _,_ _s_ 0 _∼_ _p_ _s_ 0 ( _·_ ) _._
...
1 A more detailed task description can be found at `[https://robotics.farama.org/](https://robotics.farama.org/)` .
...
Initialize policy parameters _θ_, _N_ Q-function parameters _ϕ_ _i_, empty replay buffer _D_, and episode length
_T_ . Set target parameters _ϕ_ [¯] _i_ _←_ _ϕ_ _i_, for _i_ = 1 _, ...., N_ .
1: Sample goal _g ∼_ _p_ _g_ ( _·_ ) and initial state _s_ 0 _∼_ _p_ _s_ 0 ( _·_ )
2: **for** _t_ = 0 _, .., T_ **do**
3: Take action _a_ _t_ _∼_ _π_ _θ_ ( _·|s_ _t_ ); Observe reward _r_ _t_ and next state _s_ _t_ +1 .
4: **if** _t_ = _T_ **then**

5: _D ←D_ [�] _{_ ( _s_ _t_ _, a_ _t_ _, r_ _t_ _, s_ _t_ +1 _, g_ ) _}_ _[T]_ _t_ =0 [;][ Select new goal] _[ g]_ _t_ _[′]_ [; Calculate new reward] _[ r]_ _t_ _[′]_ _[←R]_ [(] _[s]_ _[t]_ _[, a]_ _[t]_ _[, g]_ _t_ _[′]_ [);]
_D ←D_ [�] _{_ ( _s_ _t_ _, a_ _t_ _, r_ _t_ _[′]_ _[, s]_ _[t]_ [+1] _[, g]_ _t_ _[′]_ [)] _[}]_ _[T]_ _t_ =0
...
_i_ min _∈M_ _[Q]_ _[ϕ]_ [ ¯] _[i]_ [(] _[s]_ _[′]_ _[, a]_ _[′]_ _[, g]_ [)] _[ −]_ _[α]_ [ log] _[ π]_ _[θ]_ [(] _[a]_ _[′]_ _[|][s]_ _[′]_ _[, g]_ [)] _[, Q]_ [min]



_,_ _a_ _[′]_ _∼_ _π_ _θ_ ( _·|s_ _[′]_ _, g_ )



10: **for** _i_ = 1 _, ..., N_ **do**
11: Update _ϕ_ _i_ with gradient descent using
...
� ( _Q_ _ϕ_ _i_ ( _s, a, g_ ) _−_ _y_ ) [2]

( _s,a,r,s_ _[′]_ _,g_ ) _∈B_



12: Update target networks with _ϕ_ [¯] _i_ _←_ _ρϕ_ [¯] _i_ + (1 _−_ _ρ_ ) _ϕ_ _i_ .
...
� _Q_ _ϕ_ _i_ ( _s, a, g_ ) _−_ _α_ log _π_ _θ_ ( _a|s, g_ )
...
2023). HER replaces a goal _g_ of a past transition with a new goal _g_ _t_ _[′]_ [to obtain positive rewards (line 5 in]
Algorithm 1). For selecting the new goal _g_ _t_ _[′]_ [, our HER follows the future strategy. In the future strategy,]
for each transition ( _s_ _t_ _, a_ _t_ _, r_ _t_ _[′]_ _[, s]_ _[t]_ [+1] _[, g]_ [)] _[ ∈{]_ [(] _[s]_ _[t]_ _[, a]_ _[t]_ _[, r]_ _t_ _[′]_ _[, s]_ _[t]_ [+1] _[, g]_ [)] _[}]_ _[T]_ _t_ =0 [,] _[ g]_ [ is replaced with] _[ g]_ _t_ _[′]_ [, which is the achieved]
...
reward is -1 2 . Thus, we estimate _Q_ max and _Q_ min as: For any time step _t_, _Q_ max = [�] _[∞]_ _t_ _[′]_ = _t_ _[γ]_ [(] _[t]_ _[′]_ _[−][t]_ [)] _[ ·]_ [ 0 = 0, and]
_Q_ min = [�] _[∞]_ _t_ _[′]_ = _t_ _[γ]_ [(] _[t]_ _[′]_ _[−][t]_ [)] _[ ·−]_ [1 =] _[ −]_ [1] _[/]_ [(1] _[−]_ _[γ]_ [). The result (Fig. 4) shows that HER induces a divergence in Q-value]
...
_y_ = _r_ + _γ_ min �max � _i_ min _∈M_ _[Q]_ _[ϕ]_ [ ¯] _[i]_ [(] _[s]_ _[′]_ _[, a]_ _[′]_ _[, g]_ [)] _[ −]_ _[α]_ [ log] _[ π]_ _[θ]_ [(] _[a]_ _[′]_ _[|][s]_ _[′]_ _[, g]_ [)] _[, Q]_ [min] � _, Q_ max � _._ (1)
...
2 See the second paragraph in Section 2 for a reminder of the reward structure of Robotics tasks.
...
min _i∈M_ _Q_ _ϕ_ ¯ _i_ ( _s_ _[′]_ _, a_ _[′]_ _, g_ ), and (ii) the entropy term _α_ log _π_ _θ_ ( _a_ _[′]_ _|s_ _[′]_ _, g_ ). The effectiveness of these components often
...
� _Q_ _ϕ_ ¯ _i_ ( _s_ _[′]_ _, a_ _[′]_ _, g_ ) _, Q_ min
...
Initialize policy parameters _θ_, two Q-function parameters _ϕ_ _i_, empty replay buffer _D_, and episode length
_T_ . Set target parameters _ϕ_ [¯] _i_ _←_ _ϕ_ _i_, for _i_ = 1 _,_ 2.
...
min
_i∈{_ 1 _,_ 2 _}_ _[Q]_ _[ϕ]_ [ ¯] _[i]_ [(] _[s]_ _[′]_ _[, a]_ _[′]_ _[, g]_ [)] _[ −]_ _[α]_ [ log] _[ π]_ _[θ]_ [(] _[a]_ _[′]_ _[|][s]_ _[′]_ _[, g]_ [)] _[, Q]_ [min]
...
10: Update _ϕ_ _i_ with gradient descent using
...
11: Update target networks with _ϕ_ [¯] _i_ _←_ _ρϕ_ [¯] _i_ + (1 _−_ _ρ_ ) _ϕ_ _i_ .
...
|HER|number of additional goals|1<br><br>|
